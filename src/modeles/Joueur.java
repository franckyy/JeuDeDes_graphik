...
public class Joueur{
	//******attributs
	int nbrePts;	//nombre de points pour chaque joueur
	...
	public int setNbrePts(int _nbrePts){
		...
		//L'entier retourné aura la valeur 0  si le joueur à gagné, 1 par défaut et -1 si le score passe en négatif
